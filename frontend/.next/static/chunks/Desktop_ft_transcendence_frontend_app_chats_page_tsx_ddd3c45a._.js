...
const page = ()=>{
    ...
    const { user, updateFriendList, changePointedUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ft_transcendence$2f$frontend$2f$context$2f$GlobalStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ft_transcendence$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "page.useEffect": ()=>{
            async function getFriends() {
                const res = await fetch("http://localhost:4000/friendships/".concat(user === null || user === void 0 ? void 0 : user.id));
...
//# sourceMappingURL=Desktop_ft_transcendence_frontend_app_chats_page_tsx_ddd3c45a._.js.map