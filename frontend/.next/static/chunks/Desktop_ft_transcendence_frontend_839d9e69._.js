            ...
            if (manager.socket) {
                manager.socket.onmessage = ({
                    "ChatsWrapper.useEffect": (msg)=>{
                        ...
                        } else console.log("wrong place", currentChatId.current, friendship_id);
                    }
                })["ChatsWrapper.useEffect"];
            }
        }
...
_s(ChatPreview, "qR/0sEHYov0uBm4J2FdasCm923Q=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_ft_transcendence_frontend_839d9e69._.js.map