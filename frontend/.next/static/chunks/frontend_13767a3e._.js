            ...
            if (manager.gameSocket) {
                ...
                manager.gameSocket.onmessage = ({
                    "LocalGame.useEffect": (msg)=>{
                        if (canvasRef.current) (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$pong$2f$game$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startGame"])(canvasRef.current, manager.gameSocket, msg.data.toString());
                    }
                })["LocalGame.useEffect"];
...
//# sourceMappingURL=frontend_13767a3e._.js.map