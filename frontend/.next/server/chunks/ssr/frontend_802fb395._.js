...
"[project]/frontend/app/games/online/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        if (manager.gameSocket && !sentRef.current) {
            ...
            manager.gameSocket.onmessage = (msg)=>{
                ...
                if (canvasRef.current && manager.gameSocket) {
                    console.log("start");
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$pong$2f$game$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startGame"])(canvasRef.current, manager.gameSocket, msg.data);
                }
            };
        }
    }, [
...
//# sourceMappingURL=frontend_802fb395._.js.map