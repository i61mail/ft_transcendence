      ...
      <div className='flex justify-between items-center gap-4 p-4 md:px-6 md:py-4 bg-white/10 border-b border-white/10'>
        ...
        <div ref={menuRef} className="relative flex items-center gap-2">
          ...
          {!isBlocked && showInviteButton && (
            <button 
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-xs sm:text-sm font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              onClick={sendInvite}
            >
