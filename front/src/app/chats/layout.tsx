    ...
    manager.user && <>
      <div className="h-screen w-full bg-gradient-to-br from-[#c8d5e8] via-[#bcc3d4] to-[#a8b0c5] flex flex-col overflow-hidden relative">
        ...
        <div className='flex-1 flex gap-4 p-4 md:p-6 overflow-hidden relative z-10'>
          {/* Sidebar - Chat List */}
          {manager.chatIsReady && (
            <div className="w-full md:w-80 lg:w-96 flex-shrink-0 backdrop-blur-xl bg-white/10 rounded-2xl md:rounded-3xl shadow-2xl border border-white/20 overflow-hidden transition-all duration-300">
              <AllChats />
            </div>
          )}
